...
const home = () => {
    return (
        <div className="flex flex-col justify-center items-center w-screen h-screen overflow-hidden">
            <div className="relative w-[375px] h-[667px] mx-auto bg-cover bg-center overflow-hidden"
            style={{ backgroundImage: "url('/assets/home.svg')" }}>
                    ...
                    <div className="absolute w-full h-[184px] pr-[12px] pl-[12px] mb-[30px] bottom-0">
                        ...
                        <div className="w-[250px] h-[18px] font-pretendard bg-[#00FF15] text-[#ff0000] mt-[7px] font-black text-center text-[10px] border border-black">가짜? 없습니다! 200% 진실된 후기! 여러분도 가능합니다</div>
